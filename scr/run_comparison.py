...
from scr.DEviRank import DEFAULT_SEED, compare_DEviRank_Nbisdes  # noqa: E402
...
def parse_args():
    ...
    p.add_argument("--seed", default=DEFAULT_SEED, type=int, help="Random seed for degree-matched sampling")
    return p.parse_args()
